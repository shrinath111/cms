...
header {
	...
	height: 100vh;
	background:
		url('https://images.pexels.com/photos/1345085/pexels-photo-1345085.jpeg?auto=compress&cs=tinysrgb&h=650&w=940')
...
section.contact-wrap {
	...
	position: relative;
	background:
		url('https://images.pexels.com/photos/1011329/pexels-photo-1011329.jpeg?auto=compress&cs=tinysrgb&h=650&w=940')
		...
		<section class="overview-wrap" id="overview">
			<div class="container">
				<div class="contenedor">
					<h2 class="title-overview wow fadeInUp">Hello, Admin</h2>
						...
						<div class="col-md-6 col-lg-3 wow bounceInUp"
							...
							<div class="overview-box mx-auto">
								<div class="features-icons-icon d-flex">
									...
									<i class="fa fa-3x html5 m-auto">Transaction</i>
								</div>
								<h5>Transaction</h5>
								<p class=" mb-0">
									Click on the link below for Transaction Details<br>
									<a href="showPayment" class="btn btn-warning">Transaction</a>
								</p>
							</div>
						</div>
						<div class="col-md-6 col-lg-3 wow bounceInUp"
							...
							<div class="overview-box mx-auto">
								<div class="features-icons-icon d-flex">
									<!--<i class="fa fa-html5 fa-5x html5 m-auto"></i>  -->
									<i class="fa fa-3x html5 m-auto">Items</i>
								</div>
								<h5>Items</h5>
								<p class=" mb-0">
									Click on the link below for Item Details<br>
									<a href="editItems" class="btn btn-warning">Items</a>
								</p>
							</div>
						</div>
						<div class="col-md-6 col-lg-3 wow bounceInUp"
							...
							<div class="overview-box mx-auto">
								<div class="features-icons-icon d-flex">
									<!-- <i class="fa fa-html5 fa-5x html5 m-auto"></i> -->
									<i class="fa fa-3x html5 m-auto">Users</i>
								</div>
								<h5>Users</h5>
								<p class=" mb-0">
									Click on the link below for User Details<br>
									<a href="editUsers" class="btn btn-warning">Users</a>
								</p>
							</div>
						</div>
						<div class="col-md-6 col-lg-3 wow bounceInUp"
							...
							<div class="overview-box mx-auto">
								<div class="features-icons-icon d-flex">
									<!-- <i class="fa fa-html5 fa-5x html5 m-auto"></i> -->
									<i class="fa fa-3x html5 m-auto">Feedback</i>
								</div>
								<h5>Feedback</h5>
								<p class=" mb-0">
									Click on the link below for Feedback Details<br>
									<a href="feedback" class="btn btn-warning">Feedback</a>
								</p>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-12 text-center  my-auto ">
						<p class="mb-4 mb-lg-0">
							<a href="<spring:url value='/account/logout1'/>">Log Me Out</a>
						</p>
					</div>
				</div>
			</div>
