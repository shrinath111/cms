...
body {
    ...
    font-size: 16px;
    background:
		url(https://cdn.aarp.net/content/dam/aarp/home-and-family/family-and-friends/2017/04/1140-cashless.jpg)
        ...
        <section class="overview-wrap" id="overview">
            <div class="container">
                <div class="contenedor">
                    <h2 class="title-overview wow fadeInUp" style="color:blue">select payment option</h2>
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-duration="1.4s">
                            <div class="overview-box mx-auto">
                               ...
                               <i class="fa fa-5x html5 m-auto">Card</i>
                                </div>
                                <h5>CARD</h5>
                                <p class=" mb-0">Click to PAY ONLINE<br><a href="card" class="btn btn-primary">Card Payment</a></p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-duration="1.4s">
                            <div class="overview-box mx-auto">
                                <div class="features-icons-icon d-flex">
                                <!-- <i class="fa fa-html5 fa-5x html5 m-auto"></i> -->
                                <i class="fa fa-5x html5 m-auto">Cash</i>
                                </div>
                                <h5>CASH</h5>
                                <p class=" mb-0">Click To PAY ON DELIVERY<br><a href="cash" class="btn btn-warning">Cash Payment</a></p>
                            </div>
                        </div>
                       <div class="col-md-6 col-lg-3 wow bounceInUp" data-wow-duration="1.4s">
                            <div class="overview-box mx-auto">
